import { isCW20Rule, isApiRule, guildRuleToSimpleRule } from "../../src/utils/guildRuleHelpers"
import {
    APIRule,
    CW20Rule,
    GuildRule,
...
test("convert api rule", () => {
    ...
    const url: string = "https://stations.levana.finance/api/factions/free-martians?wallet=terra18nxhzmg6733r93wes7d75udfmdhr9uze0ka4rd";
...
test("verify IsCW20Rule true", () => {
    const rule: CW20Rule = {cw20Address:"terra1xj49zyqrwpv5k928jwfpfy2ha668nwdgkwlrg3", quantity: 1, roleId: "AstroHodler"};
